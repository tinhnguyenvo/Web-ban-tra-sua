...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<div class="col-lg-12">
				<h3  class="page-header">Danh sách đơn hàng đã giao
								...
								<table class="table table-bordered" id="myTable" style="margin-top:20px;">				
                                    ...
                                    @foreach($dhm  as $m)
										<tr>
											...
											<td style="color:green" >{{$m->trangthai}}</td>
											...
											<td>
												...
												<a href="{{route('xoahoadon',$m->id)}}"onclick="return confirm('Bạn có chắc chắn muốn xóa?')"><i style="color:green"class="glyphicon glyphicon-trash" aria-hidden="true"></i></a>										
											</td>
